import {
  DefaultAmplify
} from "./chunk-EZM25ESE.js";
import "./chunk-HT4LUPB7.js";
import {
  AiAction,
  AmplifyErrorCode,
  AuthAction,
...
function wo(e, t, n, r) {
  ...
  var o = e && n.reduce(function(i, a) {
    ...
    if (Y(c))
      ...
      try {
        for (var f = j(Object.keys(c)), p = f.next(); !p.done; p = f.next()) {
          var y = p.value, _ = c[y];
...
function $t(e, t) {
  var n, r, o, i, a, s, l, c, d = new Set(e), m = yr(d), f = new Set(t);
  try {
    for (var p = j(f), y = p.next(); !y.done; y = p.next())
      for (var _ = y.value, b = _.parent; b && !f.has(b); )
        f.add(b), b = b.parent;
  } catch (U) {
    n = {
      error: U
  ...
  var h2 = yr(f);
  try {
    for (var S = j(f), v = S.next(); !v.done; v = S.next()) {
      var _ = v.value;
      if (_.type === "compound" && (!h2.get(_) || !h2.get(_).length))
        ...
        try {
          for (var w = (a = void 0, j(Wt(_))), E = w.next(); !E.done; E = w.next()) {
            var I = E.value;
            f.has(I) || (f.add(I), m.get(I) ? m.get(I).forEach(function(O) {
              return f.add(O);
  ...
  try {
    for (var P = j(f), k = P.next(); !k.done; k = P.next())
      for (var _ = k.value, b = _.parent; b && !f.has(b); )
        f.add(b), b = b.parent;
  } catch (U) {
    l = {
      error: U
    ...
    function e(t, n) {
      ...
      this.machine = t, this.delayedEventsMap = {}, this.listeners = /* @__PURE__ */ new Set(), this.contextListeners = /* @__PURE__ */ new Set(), this.stopListeners = /* @__PURE__ */ new Set(), this.doneListeners = /* @__PURE__ */ new Set(), this.eventListeners = /* @__PURE__ */ new Set(), this.sendListeners = /* @__PURE__ */ new Set(), this.initialized = false, this.status = ce.NotStarted, this.children = /* @__PURE__ */ new Map(), this.forwardTo = /* @__PURE__ */ new Set(), this._outgoingQueue = [], this.init = this.start, this.send = function(d, m) {
        ...
        if (r.status === ce.Stopped)
          return ie || ue(false, 'Event "'.concat(f.name, '" was sent to stopped service "').concat(r.machine.id, `". This service has already reached its final state, and will not transition.
...
Event: `
        ...
        if ("machine" in y) {
          ...
          r.state.done) {
            ...
            !f && r.machine.config.predictableActionArguments ? r._outgoingQueue.push([y, _]) : y.send(_);
          }
        } else
          !f && r.machine.config.predictableActionArguments ? r._outgoingQueue.push([y, d.data]) : y.send(d.data);
      }, this._exec = function(d, m, f, p) {
        p === void 0 && (p = r.machine.options.actions);
        var y = d.exec || wn(d.type, p), _ = Y(y) ? y : y ? y.exec : d.exec;
        if (_)
          try {
            return _(m, f.data, r.machine.config.predictableActionArguments ? {
              action: d,
              _event: f
            } : {
              action: d,
        ...
        switch (d.type) {
          ...
          case Ht:
            ...
            if (typeof h2.delay == "number") {
              ...
              h2.to ? r.sendTo(h2._event, h2.to, f === nt) : r.send(h2._event);
            break;
          case $r:
            r.cancel(d.sendId);
            break;
          case yn: {
            ...
            if (S.type === Z.Invoke) {
              ...
              var k = I ? Sn(I, m, f) : void 0;
              if (typeof w == "string")
                return;
              var U = Y(w) ? w(m, f.data, {
                data: k,
                src: v,
                meta: S.meta
              }) : w;
    ...
    return Object.defineProperty(e.prototype, "initialState", {
      ...
      try {
        for (var m = j(this.listeners), f = m.next(); !f.done; f = m.next()) {
          var p = f.value;
...
Event: `).concat(JSON.stringify(event)));
      ...
      var r, o = this, i = false, a = /* @__PURE__ */ new Set(), s = /* @__PURE__ */ new Set(), l, c = function(f) {
  ...
  function() {
    function e(t, n, r, o) {
      ...
      this.config = t, this._context = r, this.order = -1, this.__xstatenode = true, this.__cache = {
        ...
        return Object.assign(i.idMap, T((m = {}, m[f.id] = f, m), f.idMap)), f;
      }) : st;
      var s = 0;
      function l(c) {
        var d, m;
        c.order = s++;
        try {
          for (var f = j(Xi(c)), p = f.next(); !p.done; p = f.next()) {
            var y = p.value;
            l(y);
          }
        } catch (_) {
      ...
      l(this), this.history = this.config.history === true ? "shallow" : this.config.history || false, this._transient = !!this.config.always || (this.config.on ? Array.isArray(this.config.on) ? this.config.on.some(function(c) {
        ...
        if (Ve(c)) {
          ...
          var p = c.id || nn(i.id, d);
          return i.machine.options.services = T((f = {}, f[p] = c.src, f), i.machine.options.services), rn(T(T({
            id: p
          }, c), {
            src: p
          }));
    ...
    return e.prototype._init = function() {
      ...
      try {
        for (var s = j(Object.keys(t)), l = s.next(); !l.done; l = s.next()) {
          var c = l.value, d = t[c];
          if (d) {
            var m = this.getStateNode(c), f = m._transition(d, n, r);
            f && (a[c] = f);
          }
        }
      } catch (h2) {
      ...
      try {
        for (var d = j(this.getCandidates(a)), m = d.next(); !m.done; m = d.next()) {
          var f = m.value, p = f.cond, y = f.in, _ = t.context, b = y ? K(y) && lt(y) ? (
...
`).concat(w.message));
          ...
          if (h2 && b) {
            f.target !== void 0 && (l = f.target), s.push.apply(s, X([], H(f.actions), false)), c = f;
            break;
          }
        }
      } catch (w) {
      ...
      var l, c, d, m, f = this, p = a ? $t([], this.getStateNodes(a.value)) : [], y = /* @__PURE__ */ new Set();
      try {
      ...
      var w = Array.from(y).sort(function($, B) {
        ...
        return {
          type: "entry",
          actions: ze(s ? X(X([], H(B), false), H(z), false) : X(X([], H(z), false), H(B), false), f.machine.options.actions)
        };
      }).concat({
        type: "state_done",
        ...
        return {
          ...
          actions: ze(X(X([], H($.onExit), false), H($.activities.map(function(B) {
            return Hi(B);
          })), false), f.machine.options.actions)
        };
      }), U = k.concat({
        type: "transition",
      ...
      var a, s, l, c, d = this;
      i === void 0 && (i = nt);
      var m = t.configuration, f = !n || t.transitions.length > 0, p = f ? t.configuration : n ? n.configuration : [], y = hn(p, this), _ = f ? ru(this.machine, m) : void 0, b = n ? n.historyValue ? n.historyValue : t.source ? this.machine.historyValue(n.value) : void 0 : void 0, h2 = this.getActions(new Set(p), y, t, r, i, n, o), S = n ? T({}, n.activities) : {};
      try {
        ...
        if (i)
          try {
            for (var s = j(Object.keys(i)), l = s.next(); !l.done; l = s.next()) {
              ...
              if (d.states)
                try {
                  for (var m = (r = void 0, j(d.events)), f = m.next(); !f.done; f = m.next()) {
                    var p = f.value;
                    a.add("".concat(p));
                  }
                } catch (y) {
...
`).concat(s.message));
      ...
      var f = oe(this.invoke.map(function(S) {
        var v = [];
      ...
      })), p = this.after, y = oe(X(X(X(X([], H(m), false), H(f), false), H(o), false), H(d), false).map(function(S) {
...
function Np(e, t, n, r, o, i) {
  ...
  if (c && d)
    return c == t && d == e;
  var m = -1, f = true, p = n & Mp ? new Tp() : void 0;
...
function Qg(e, t, n, r, o, i) {
  ...
  for (var b = a; ++m < l; ) {
    ...
    var h2 = e[f], S = t[f];
    if (r)
      var v = a ? r(S, h2, f, t, e, i) : r(h2, S, f, e, t, i);
...
function kh(e, t, n, r, o, i) {
  ...
  return f ? (i || (i = new ar()), Eh(e, t, n, r, o, i)) : false;
}
var Mh = kh;
var Nh = Mh;
var Jo = ot;
...
function $w(e, t, n, r, o, i, a) {
  ...
  if (m) {
    var f = si(l), p = !f && kw(l), y = !f && !p && Fw(l);
    d = l, f || p || y ? si(s) ? d = s : Pw(s) ? d = Tw(s) : p ? (m = false, d = Aw(l, true)) : y ? (m = false, d = Ew(l, true)) : d = [] : Uw(l) || ai(l) ? (d = s, ai(s) ? d = Ow(s) : (!Nw(s) || Mw(s)) && (d = Iw(l))) : m = false;
  }
...
var Ze = {
  async getAmplifyConfig() {
    var s, l, c, d;
    const e = DefaultAmplify.getConfig(), t = (s = e.Auth) == null ? void 0 : s.Cognito, { loginWith: n, userAttributes: r } = ((l = e.Auth) == null ? void 0 : l.Cognito) ?? {}, o = n ? Object.entries(n).filter(([m, f]) => m !== "oauth").filter(([m, f]) => !!f).map((m) => m[0] === "phone" ? "phone_number" : m[0]) : void 0, i = Fb(r), a = (c = n == null ? void 0 : n.oauth) != null && c.providers ? (d = n.oauth.providers) == null ? void 0 : d.map((m) => m.toString().toLowerCase()) : void 0;
    return {
      ...t,
      loginMechanisms: o,
      signUpAttributes: i,
...
var Oa = defineComponent({
  ...
  setup(e) {
    const t = e, n = F("Show password"), r = F("Hide password"), o = ref("password"), i = ref(n), a = Math.floor(Math.random() * 999999), { name: s, label: l, autocomplete: c, hasError: d, labelHidden: m, placeholder: f, required: p } = toRefs(t), y = ref("");
    function _() {
      i.value = i.value === n ? r : n, o.value = o.value === "password" ? "text" : "password";
    }
    const b = F((f == null ? void 0 : f.value) ?? l.value), h2 = F(l.value);
    return (S, v) => {
...
var $a = defineComponent({
  ...
  setup(e) {
    ...
    return (m, f) => (openBlock(), createElementBlock(Fragment, null, [
...
var io = defineComponent({
  ...
  setup(e) {
    const t = he(), { route: n, socialProviders: r } = t, o = r == null ? void 0 : r.includes("amazon"), i = r == null ? void 0 : r.includes("apple"), a = r == null ? void 0 : r.includes("facebook"), s = r == null ? void 0 : r.includes("google"), l = a || s || o || i, { getSignInWithFederationText: c, getOrText: d } = Se, m = computed(() => fr), f = computed(() => c(n, "amazon")), p = computed(() => c(n, "apple")), y = computed(() => c(n, "facebook")), _ = computed(() => c(n, "google")), b = computed(() => d());
    return (h2, S) => {
      const v = me;
      return unref(l) ? (openBlock(), createBlock(v, {
        ...
        default: withCtx(() => [
          unref(o) ? (openBlock(), createBlock(cn, {
            ...
            default: withCtx(() => [
              bC,
              createBaseVNode("span", CC, toDisplayString(unref(f)), 1)
            ]),
            _: 1
...
var Ra = defineComponent({
  __name: "sign-in",
  setup(e) {
    const t = he(), { submitForm: n, updateForm: r, toForgotPassword: o } = t, { error: i, isPending: a } = toRefs(t), { getForgotPasswordText: s, getSignInText: l, getSigningInText: c } = Se, d = computed(() => s()), m = computed(() => l()), f = computed(() => c()), p = (b) => {
                ...
                createVNode(E, { class: "amplify-flex amplify-authenticator__column" }, {
                  default: withCtx(() => [
                    ...
                    createVNode(w, {
                      ...
                      default: withCtx(() => [
                        createTextVNode(toDisplayString(unref(a) ? unref(f) : unref(m)), 1)
                      ]),
                      _: 1
                    }, 8, ["disabled"])
                  ]),
...
var La = defineComponent({
  ...
  setup(e) {
    const t = he(), { codeDeliveryDetails: n, error: r, isPending: o } = toRefs(t), { resendCode: i, submitForm: a, updateForm: s } = t, { getDeliveryMethodText: l, getDeliveryMessageText: c, getResendCodeText: d, getConfirmText: m } = Se, f = computed(() => l(n.value)), p = computed(() => d()), y = computed(() => m()), _ = computed(() => c(n.value)), b = (w) => {
...
var Ba = defineComponent({
  ...
  setup(e) {
    const t = he(), { submitForm: n, toSignIn: r, updateForm: o } = t, { error: i, isPending: a, challengeName: s } = toRefs(t), l = computed(() => s.value), { getBackToSignInText: c, getConfirmText: d, getChallengeText: m } = Se, f = computed(() => m(l.value)), p = computed(() => c()), y = computed(() => d()), _ = (S) => {
...
(function(e) {
  ...
  e.isValid = function(o) {
    ...
    for (let m = 0; m < i; m++) {
      ...
      for (let f = 0; f < i; f++) {
        let p = o.get(m, f);
        p === c ? s++ : (s >= 5 && (a += t.N1 + (s - 5)), c = p, s = 1), p = o.get(f, m), p === d ? l++ : (l >= 5 && (a += t.N1 + (l - 5)), d = p, l = 1);
      }
...
(function(e) {
  ...
  function m(f, p) {
    for (let y = 1; y <= 40; y++)
      if (d(f, y) <= e.getCapacity(y, p, o.MIXED))
        return y;
  }
  e.from = function(p, y) {
...
(function(e) {
  var t = {
    single_source_shortest_paths: function(n, r, o) {
      ...
      s.push(r, 0);
      for (var l, c, d, m, f, p, y, _, b; !s.empty(); ) {
        l = s.pop(), c = l.value, m = l.cost, f = n[c] || {};
        for (d in f)
          f.hasOwnProperty(d) && (p = f[d], y = m + p, _ = a[d], b = typeof a[d] > "u", (b || _ > y) && (a[d] = y, s.push(d, y), i[d] = c));
      }
    ...
    for (let I = 0; I < h2.length; I++) {
      ...
      for (let U = 0; U < P.length; U++) {
        ...
        for (let B = 0; B < E.length; B++) {
          const z = E[B];
          v[z] && v[z].node.mode === O.mode ? (w[z][$] = f(v[z].lastCount + O.length, O.mode) - f(v[z].lastCount, O.mode), v[z].lastCount += O.length) : (v[z] && (v[z].lastCount = O.length), w[z][$] = f(O.length, O.mode) + 4 + t.getCharCountIndicator(O.mode, S));
        }
      }
      E = k;
    }
...
function A1(e, t, n) {
  const r = Xn.getSymbolTotalCodewords(t), o = Pr.getTotalCodewordsCount(t, n), i = r - o, a = Pr.getBlocksCount(t, n), s = r % a, l = a - s, c = Math.floor(r / a), d = Math.floor(i / a), m = d + 1, f = c - d, p = new g1(f);
  let y = 0;
...
(function(e) {
  ...
  e.getOptions = function(r) {
    ...
    for (let f = 0; f < c; f++)
      for (let p = 0; p < c; p++) {
        let y = (f * c + p) * 4, _ = i.color.light;
        if (f >= d && p >= d && f < c - d && p < c - d) {
          const b = Math.floor((f - d) / l), h2 = Math.floor((p - d) / l);
          _ = m[s[b * a + h2] ? 1 : 0];
        }
...
(function(e) {
  ...
  e.render = function(i, a, s) {
    ...
    const d = t.getImageWidth(i.modules.size, l), m = c.getContext("2d"), f = m.createImageData(d, d);
    return t.qrToImageData(f.data, i, l), n(m, c, d), m.putImageData(f, 0, 0), c;
...
ts.render = function(t, n, r) {
  const o = T1.getOptions(n), i = t.modules.size, a = t.modules.data, s = i + o.margin * 2, l = o.color.light.a ? "<path " + mi(o.color.light, "fill") + ' d="M0 0h' + s + "v" + s + 'H0z"/>' : "", c = "<path " + mi(o.color.dark, "stroke") + ' d="' + I1(a, i, o.margin) + '"/>', d = 'viewBox="0 0 ' + s + " " + s + '"', f = '<svg xmlns="http://www.w3.org/2000/svg" ' + (o.width ? 'width="' + o.width + '" height="' + o.width + '" ' : "") + d + ' shape-rendering="crispEdges">' + l + c + `</svg>
`;
...
var O1 = defineComponent({
  __name: "setup-totp",
  setup(e) {
    const t = new ConsoleLogger("SetupTotp-logger"), n = he(), { updateForm: r, submitForm: o, toSignIn: i, totpSecretCode: a, username: s, QRFields: l } = n, { error: c, isPending: d } = toRefs(n), { totpIssuer: m = "AWSCognito", totpUsername: f = s } = l ?? {}, p = yl(m, f, a), y = reactive({
      qrCodeImageSource: "",
      isLoading: true
...
var os = defineComponent({
  ...
  setup(e) {
    const t = he(), { submitForm: n, toSignIn: r, updateBlur: o, updateForm: i } = t, { error: a, isPending: s } = toRefs(t), { getChangePasswordText: l, getChangingText: c, getBackToSignInText: d } = Se, m = computed(() => l()), f = computed(() => c()), p = computed(() => d()), y = () => {
      r();
    }, _ = (v) => {
      b(v);
    }, b = (v) => {
                    ...
                    createVNode(U, { class: "amplify-flex amplify-authenticator__column" }, {
                      default: withCtx(() => [
                        ...
                        createVNode(k, {
                          ...
                          default: withCtx(() => [
                            createTextVNode(toDisplayString(unref(s) ? unref(f) + "…" : unref(m)), 1)
                          ]),
                          _: 1
                        }, 8, ["disabled"]),
                        createVNode(k, {
...
var is = defineComponent({
  ...
  setup(e) {
    const t = he(), { submitForm: n, toSignIn: r, updateForm: o } = t, { error: i, isPending: a } = toRefs(t), { getBackToSignInText: s, getResetYourPasswordText: l, getSendCodeText: c } = Se, d = computed(() => s()), m = computed(() => l()), f = computed(() => c()), p = (b) => {
      n(ke(b));
    }, y = (b) => {
      const { name: h2, value: S } = b.target;
      o({ name: h2, value: S });
...
var as = defineComponent({
  ...
  setup(e) {
    const t = he(), { resendCode: n, submitForm: r, updateBlur: o, updateForm: i } = t, { error: a, isPending: s } = toRefs(t), { getResendCodeText: l, getResetYourPasswordText: c, getSubmitText: d } = Se, m = computed(() => l()), f = computed(() => c()), p = computed(() => d()), y = (v) => {
      _(v);
    }, _ = (v) => {
      r(ke(v));
    }, b = () => {
...
var ss = defineComponent({
  __name: "verify-user",
  setup(e) {
    const t = he(), { isPending: n, unverifiedUserAttributes: r, error: o } = toRefs(t), { skipVerification: i, submitForm: a, updateForm: s } = t, { getAccountRecoveryInfoText: l, getSkipText: c, getVerifyText: d, getVerifyContactText: m } = Se, f = computed(() => l()), p = computed(() => c()), y = computed(() => d()), _ = computed(() => m()), b = (w) => {
      const { name: E, value: I } = w.target;
      s({ name: E, value: I });
    }, h2 = (w) => {
      S(w);
...
var ls = defineComponent({
  ...
  setup(e) {
    const t = he(), { error: n, isPending: r } = toRefs(t), { skipVerification: o, submitForm: i, updateForm: a } = t, { getAccountRecoveryInfoText: s, getSkipText: l, getSubmitText: c } = Se, d = computed(() => s()), m = computed(() => l()), f = computed(() => c()), p = (h2) => {
...
var cs = defineComponent({
  ...
  setup(e) {
    const t = Math.floor(Math.random() * 999999), n = he(), { submitForm: r, toSignIn: o, updateForm: i } = n, { error: a, isPending: s, challengeName: l, allowedMfaTypes: c } = toRefs(n), d = computed(() => l.value), { getBackToSignInText: m, getConfirmText: f, getSelectMfaTypeByChallengeName: p, getMfaTypeLabelByValue: y, getSelectMfaTypeText: _ } = Se, b = computed(() => p(d.value)), h2 = computed(() => m()), S = computed(() => f()), v = computed(() => _()), w = (P) => {
...
var us = defineComponent({
  __name: "setup-email",
  setup(e) {
    const t = he(), { submitForm: n, toSignIn: r, updateForm: o } = t, { error: i, isPending: a } = toRefs(t), { getBackToSignInText: s, getConfirmText: l, getSetupEmailText: c } = Se, d = computed(() => c()), m = computed(() => s()), f = computed(() => l()), p = (b) => {
      const { name: h2, value: S } = b.target;
      o({ name: h2, value: S });
    }, y = (b) => {
      n(ke(b));
...
var L1 = defineComponent({
  ...
  setup(e) {
    ...
    let d;
    const m = ref(false), { service: f, send: p, state: y } = oo(), _ = f.subscribe((R) => {
